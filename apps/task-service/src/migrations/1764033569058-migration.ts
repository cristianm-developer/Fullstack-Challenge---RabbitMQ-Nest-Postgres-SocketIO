...
export class Migration1764033569058 implements MigrationInterface {
    name = 'Migration1764033569058'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "task" ("id" SERIAL NOT NULL, "created_by" integer NOT NULL, "title" character varying(255) NOT NULL, "description" text, "deadline" TIMESTAMP, "priority" "public"."task_priority_enum" NOT NULL DEFAULT 'MEDIUM', "status" "public"."task_status_enum" NOT NULL DEFAULT 'TODO', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
